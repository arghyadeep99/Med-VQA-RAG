...
def main():
    ...
    test_image = "./datasets/mimic-cxr-images-512/files/p19/p19000065/s51613820/58f383e7-edcbd8c7-2f6dc2af-eb97ddf1-f7cbc46a.jpg"
    test_report = "./datasets/mimic-cxr/files/p19/p19000065/s51613820.txt"
