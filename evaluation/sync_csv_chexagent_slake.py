...
files = ["./filtered_datasets_2/filtered_chexagent_preds_slake_baseline.csv",
         "./filtered_datasets_2/filtered_chexagent_preds_slake_graphrag.csv",
         "./filtered_datasets_2/filtered_chexagent_preds_slake_only_rag.csv"]
